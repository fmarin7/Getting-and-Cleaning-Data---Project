...
## download.file(fileUrl, destfile = "./data/UCI HAR Dataset")
...
write.table(allData.mean, "./Getting and Cleaning Data Course Project/tidy_data.txt", row.names = FALSE, quote = FALSE)
